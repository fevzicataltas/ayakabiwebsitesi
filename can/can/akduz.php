...
if (isset($_GET['id'])) {
    ...
    $sorgu = "SELECT * FROM ayakabilar WHERE id='$id'";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $guncellemeSorgusu = "UPDATE ayakabilar SET baslik='$baslik', fiyat='$fiyat', aciklama='$aciklama' WHERE id='$id'";

    if ($conn->query($guncellemeSorgusu) === TRUE) {
        echo "Veri başarıyla güncellendi.";
        header('Location: ayakabilist.php');
        exit;
    } else {
        echo "Hata: " . $guncellemeSorgusu . "<br>" . $conn->error;
    }
}
            ...
            <div class="form-container">
                ...
                <input type="hidden" name="id" value="<?php echo $id; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="fiyat" name="fiyat" value="<?php echo $fiyat; ?>" step="0.01" required>
                    </div>
                    <div class="form-group">
                        <label for="aciklama">Açıklama:</label>
                        <textarea id="aciklama" name="aciklama" rows="4"value="<?php echo $aciklama; ?>" required></textarea>
                    </div>
                    <div class="form-group">
