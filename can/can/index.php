    ...
    <section id="hero" class="hero section">
      ...
      <div class="container text-center">
        <div class="d-flex flex-column justify-content-center align-items-center">
          <h1 data-aos="fade-up">Hoşgeldiniz <span>Can Ayakabiya</span></h1>
          <p data-aos="fade-up" data-aos-delay="100">Türkiyenin en güvenilir markası <br></p>
          <div class="d-flex" data-aos="fade-up" data-aos-delay="200">
            <a href="ayakabi.php" class="btn-get-started">Alışverişe Başla</a>
          </div>
